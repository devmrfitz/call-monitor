...
class HangupVerb extends verb_1.Verb {
    async run() {
        logger_1.default.verbose(`@fonoster/voice sending hangup request [sessionId = ${this.request.sessionId}]`);
        return new Promise(async (resolve, reject) => {
            let token;
            try {
                token = pubsub_js_1.default.subscribe(`SessionClosed.${this.request.sessionId}`, (type, data) => {
                    resolve();
